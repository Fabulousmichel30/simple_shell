...
/**
 * series of check-chains in order to continue chaining based on last situation
 * @info: parameter struct
 * @buf: the character buf
 * @p: bearing of the current position in buffer
 * @i: starting position in buffer
 * @len: the length of it
 *
 * Return: null
 */
...
/**
 * replace_alias - replaces some aliases in kenized string
 * @info: parameter struct
...
/**
 * replace_vars - To replaces vars in tokenized string
 * @info: parameter struct
 *
 * Return: 1 if replaced, 0 if not.
 */
...
/**
 * replace_string - replaces old string with new one
